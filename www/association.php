...
<body>
  ...
  <div id="content" >
    <div id="centercolumn">
      <p class="SousTitreC">La Mission</p>
      <br>
      <p class="TexteC">Fondée en mars 2016 la mission de l’association Onl’Fait est de créer, animer et maintenir des espaces dédiés (fablabs) à l’innovation technologique pour des particuliers et organisations souhaitant apprendre, enseigner et partager de façon collective sur des problématiques techniques, sociales et environnementales et ainsi développer la responsabilité citoyenne de chacun.</p>
      <br>
      <p class="SousTitreC">Les Statuts</p>
      <br>
      <p class="TexteC"><a href="Document/Status/Status_juillet_2017_signée.pdf"> TÉLÉCHARGER LES STATUTS AU FORMAT PDF </a></p>
      <br>
      <p class="SousTitreC">Le Comité</p>
      <br>
      <table class="TexteC">
        <tr>
          <td>
